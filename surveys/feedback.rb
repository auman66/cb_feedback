...
q_receipt "Did the company confirm the receipt of application?", :pick => :one
  ...
  q_3 "How did they get in touch?", :pick => :any
    ...
    q_interview_2 "After the interview how long did it take to hear back?", :pick => :one
    a_1 "A week or less."
    ...
    condition_A :q_interview_3, "count>=1"
